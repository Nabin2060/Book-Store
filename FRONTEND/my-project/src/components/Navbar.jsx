...
const Navbar = () => {
  ...
  useEffect(() => {
    if (theme === "dark") {
      ...
      // localStorage.removeItem("theme"); // to remove theme from local storage if needed
    }
  }, [theme]);
    ...
    <>
      <div
        className={` max-w-screen-2xl container mx-auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 z-50 ${
          sticky
            ? "sticky-navbar shadow-md bg-base-200 dark:bg-purple-800 dark:text-white duration-300 transition-all ease-in-out"
            : ""
        }`}
      >
        <div className="navbar ">
          ...
          <div className="navbar-end">
            ...
            <label className="swap swap-rotate">
              ...
              {/* moon icon */}
              <svg
                className="swap-on h-7 w-87 fill-current"
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
...

            {
              authUser ? (
                ...
                <div className="">
                <a
                  className="bg-black text-white  rounded-md hover:bg-slate-800 duration-300 cursor-pointer"
